...
## Networking
- There's an A Record at new-be.buckfifty-ai-herdmanager.click that points to the public ip address of the ec2 instance
...
- ToDo: setup the reverse proxy, and create an SSL/TLS certificate to serve traffic over https